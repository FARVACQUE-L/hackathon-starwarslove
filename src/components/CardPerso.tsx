    ...
    return (
        <article className="card-perso">
            ...
            <div className="card-perso__content">
                ...
                <p><strong>Espèce:</strong> {character.species || "Inconnu"}</p>
                <p><strong>Genre:</strong> {getGenderLabel(character.gender)}</p>
                <p><strong>Planète:</strong> {character.homeworld || "Inconnu"}</p>
                <p><strong>Couleur des yeux:</strong> {character.eyeColor || "Inconnu"}</p>
                <p><strong>Taille:</strong> {character.height || "Inconnu"}</p>
